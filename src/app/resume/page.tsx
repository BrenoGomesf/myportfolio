                                ...
                                <div className="row align-items-center gx-5">
                                    <div className="col text-center text-lg-start mb-4 mb-lg-0">
                                        <div className="bg-light p-4 rounded-4">
                                            ...
                                            <div className="small fw-bolder">FullStack Developer</div>
                                            <div className="small text-muted">Goiânia - GO</div>
                                        </div>
                                    </div>
                        ...
                        <div className="card shadow border-0 rounded-4 mb-5">
                            <div className="card-body p-5">
                                <div className="row align-items-center gx-5">
                                    <div className="col text-center text-lg-start mb-4 mb-lg-0">
                                        <div className="bg-light p-4 rounded-4">
                                            <div className="text-secondary fw-bolder mb-2">2021 - 2023</div>
                                            <div className="mb-2">
                                                <div className="small fw-bolder">SENAI - FATESG</div>
                                                <div className="small text-muted">Goiânia - GO</div>
                                            </div>
                                            <div className="fst-italic">
                                                <div className="small text-muted">ADS</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="col-lg-8"><div>I graduated in ADS (Systems Analysis and Development), where I improved my skills in technology and software development.</div></div>
                                </div>
                            </div>
                        </div>
                    </section>
                            ...
                            <div className="card-body p-5">
                                <div className="mb-5">
                                    ...
                                    <div className="row row-cols-1 row-cols-md-3 mb-4">
                                        ...
                                        <div className="col mb-4 mb-md-0"><div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">Team work</div></div>
                                ...
                                <div className="mb-0 mt-2">
                                    <div className="row row-cols-1 row-cols-md-3 mb-4">
                                        ...
                                        <div className="col mb-4 mb-md-0"><div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">TypeScript</div></div>
                                        <div className="col"><div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">Node.js</div></div>
                                    </div>
                                </div>
                                <div className="mb-0  mt-2">
                                    <div className="row row-cols-1 row-cols-md-3">
                                        <div className="col mb-4 mb-md-0"><div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">Nest.js</div></div>
                                        <div className="col mb-4 mb-md-0"><div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">Java</div></div>
                                        <div className="col"><div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">Ruby on Rails </div></div>
                                    </div>
                                </div>
                                <div className="mb-0  mt-2">
                                    <div className="row row-cols-1 row-cols-md-3">
                                    ...
                                    <div className="row row-cols-1 row-cols-md-3">
                                        <div className="col mb-4 mb-md-0"><div className="d-flex align-items-center bg-light rounded-4 p-3 h-100">Architecture</div></div>
                                    </div>
                                </div>
                            </div>
                        </div>
